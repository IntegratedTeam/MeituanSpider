...
class AddressSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for hotel in hotellist:
            # try:
                ...
                name=hotel['name']
                hotel_address={}
                hotel_address['hotel_id']=hotel_id
                hotel_address['hotel_name'] = name
                hotel_address['lat']=lat
                hotel_address['lng']=lng
                hotel_addresses.append(hotel_address)
        self.save_hotel_address(hotel_addresses)
    ...
    def save_hotel_address(self, hotel_addresses):
        ...
        for hotel_address in hotel_addresses:
            print(hotel_address['hotel_name'])
            print(hotel_address['lat'])
            cur.execute(
            "INSERT INTO hotel_location(hotel_id,hotel_name,lat,lng) VALUES (%d,'%s',%f,%f)" % (
                hotel_address['hotel_id'],hotel_address['hotel_name'],hotel_address['lat'],hotel_address['lng']))
